...
export function KivoTopBar() {
  return (
    <header className="relative z-20 flex items-center justify-between px-[20px] pt-[calc(env(safe-area-inset-top)+10px)]">
      ...
      {/* Right credits pill */}
      <button className="flex h-[40px] items-center gap-[6px] rounded-full border border-[#dedee2] bg-[#f8f8f9] px-[14px] text-[18px] font-medium tracking-[-0.02em] text-[#292a2e]">
