...
import { ArrowUpRight, CalendarDays, Check, ChevronLeft, Clock, Eye, Lock, Sparkles, Trash2 } from 'lucide-react';
        ...
        <div className="h-full overflow-y-auto px-[26px] pb-[calc(env(safe-area-inset-bottom)+22px)] pt-[88px]">
          ...
          <div className="mt-[32px] rounded-[22px] border border-[#ececef] bg-white/46 px-[20px] py-[18px] shadow-[0_8px_26px_rgba(15,23,42,0.018)] backdrop-blur-[14px]">
            ...
            <div className="mt-[18px] space-y-[14px]">
              ...
              <Capability icon={<Clock size={19} strokeWidth={2.1} />} title="Find better time slots" subtitle="Spot free time and suggest when to focus." />
              <Capability icon={<Sparkles size={19} strokeWidth={2.1} />} title="Plan your day" subtitle="Turn your calendar into useful daily briefings." divider={false} />
            </div>
          </div>
