...
function AuthInput({ icon, placeholder, rightIcon }: { icon: React.ReactNode; placeholder: string; rightIcon?: React.ReactNode }) {
  return (
    <div className="flex h-[54px] items-center rounded-[27px] border border-[#ececef] bg-white/42 px-[18px] shadow-[inset_0_1px_0_rgba(255,255,255,0.65),0_8px_24px_rgba(15,23,42,0.022)] backdrop-blur-[14px]">
...
export function KivoAuthScreen() {
  return (
    <main className="relative h-[100dvh] overflow-hidden bg-[#f4f4f6] text-[#202024]">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_30%,#ffffff_0%,#f7f7f8_54%,#f0f0f2_100%)]" />

      <div className="relative z-10 mx-auto flex h-[100dvh] w-full max-w-[430px] flex-col px-[40px] pt-[calc(env(safe-area-inset-top)+32px)] pb-[calc(env(safe-area-inset-bottom)+18px)]">
        ...
        <section className="mt-[50px] space-y-[9px]">
        ...
        <button className="mt-[18px] flex h-[60px] items-center justify-center rounded-[27px] bg-[#111113] px-[22px] text-[18px] font-medium tracking-[-0.03em] text-white shadow-[0_16px_34px_rgba(0,0,0,0.12)]">
          <span className="flex-1 text-center">Create account</span>
          <ArrowRight size={24} strokeWidth={1.8} />
        </button>

        <div className="mt-[24px] flex items-center gap-[18px] px-[14px]">
        ...
        <section className="mt-[16px] space-y-[10px]">
          <button className="flex h-[54px] w-full items-center justify-center rounded-[27px] border border-[#ececef] bg-white/42 text-[17px] font-medium tracking-[-0.03em] text-[#202024] shadow-[0_8px_24px_rgba(15,23,42,0.02)] backdrop-blur-[14px]">
            <span className="mr-[22px] flex h-[22px] w-[22px] items-center justify-center"><GoogleIcon /></span>
        ...
        <div className="mt-auto flex items-center justify-center gap-[18px] pb-[12px] pt-[22px] text-[16px] tracking-[-0.025em]">
